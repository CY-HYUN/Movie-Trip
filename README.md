...
- [ ] Normalize 8 regional tables into single `Place` table
...
- [ ] **Collaborative Routes**: Plan trips with friends
- [ ] **Offline Mode**: Download routes for offline use
- [ ] **Photo Upload**: Users upload location photos
- [ ] **AR Navigation**: Augmented reality waypoint guidance
- [ ] **Weather Integration**: Real-time weather for locations
- [ ] **Public Transit**: Add bus/subway route options
...
- [ ] Implement image CDN (Cloudflare, AWS CloudFront)
...
- [ ] Implement Post/Comment system (schema already defined)
...
- **Project Repository**: [GitHub](https://github.com/your-username/movie-trip)
- **Issues**: [GitHub Issues](https://github.com/your-username/movie-trip/issues)
...
**Built with ❤️ for Korean travel enthusiasts**

**⭐ Star this repo if you find it helpful!**

[Report Bug](https://github.com/your-username/movie-trip/issues) · [Request Feature](https://github.com/your-username/movie-trip/issues)
